...
<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:flyshop@gmail.com"><i class="fas fa-envelope"></i> Flyshop@gmail.com</a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>FireFly</span> | all rights reserved!</div>
